...
#include "tensorflow_esp32/tensorflow/lite/core/api/error_reporter.h"
...
#include "tensorflow_esp32/tensorflow/lite/experimental/micro/micro_optional_debug_tools.h"
